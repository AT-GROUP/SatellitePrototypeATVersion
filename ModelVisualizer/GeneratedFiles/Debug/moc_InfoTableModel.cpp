...
#include "../../../src/ModelVisualizer/InfoTableModel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_InfoTableModel_t, stringdata) + ofs \
...
const QMetaObject InfoTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_InfoTableModel.data,
      qt_meta_data_InfoTableModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InfoTableModel.stringdata))
        return static_cast<void*>(const_cast< InfoTableModel*>(this));
